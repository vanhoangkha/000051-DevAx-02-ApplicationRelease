...
9.  Cuộn xuống phần **Environment configuration**.
- Chọn tab **Amazon EC2 Instances**.
- Trong **Tab group 1** section, chọn **Name** cho mục **Key**.
- Chọn **idevelop** cho mục **Value**

![CreateCodeDeployApp](/images/4/15.png?width=90pc)

10. Trong **Matching instances** section, bạn sẽ thấy 2 instance, 2 instance này đủ điều kiện để là một target cho Deployment Group này, vì có *Name* tag là *idevelop*.
11. Chọn **Create Deployment Group**
