...
7. Nhập tên stack tại mục **Stack name**, ví dụ: `aws-stack-for-DevAX-lab02`.
8. Chọn keypair **KPforDevAxInstances** cho mục **EEKeyPair** và nhấn **Next**
...
11. Chúng ta cần chờ khoảng hơn 30 phút để các tài nguyên được khởi tạo và cấu hình.
